    ...
    <div className="space-y-8">
      ...
      <div className="card space-y-6">
        <div className="flex items-center space-x-4">
          <div className="w-12 h-12 bg-gradient-to-r from-violet-600 to-cyan-600 rounded-2xl flex items-center justify-center shadow-glow">
          ...
          <div>
            ...
            <p className="text-slate-400">Configure app preferences and security</p>
          </div>
        </div>
      </div>
      ...
      <div className="card space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-slate-200">Display Preferences</h3>
            <p className="text-sm text-slate-400">Customize how time and information is displayed</p>
          </div>
        </div>
      ...
      <div className="card space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-slate-200">Billing & Rates</h3>
            <p className="text-sm text-slate-400">Configure your salary and hourly rates</p>
          </div>
        </div>
      ...
      <div className="card space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-slate-200">Vacation & Attendance</h3>
            <p className="text-sm text-slate-400">Manage your time off and track attendance</p>
          </div>
        </div>
      ...
      <div className="card space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Sync your data across devices</p>
          </div>
        </div>
      ...
      <div className="card space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Protect your app with a passcode</p>
          </div>
        </div>
      ...
      <div className="card space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">View statistics and manage your data</p>
          </div>
        </div>
